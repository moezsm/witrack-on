...
defaultOptions = {
	...
	lang: {
		...
		months: ['Janvier', 'Février', 'Mars', 'Avril', 'Mai', 'Juin', 'Juillet',
				'Aout', 'September', 'October', 'November', 'December'],
...
Chart.prototype = {
	 ...
	 * @param subtitlezoneOptions {Object} New subtitlezone options
	 *
	 */
	setTitle: function (titleOptions, subtitleOptions, subtitlezoneOptions) {
		var chart = this,
			options = chart.options,
			chartTitleOptions,
		...
		chartsubtitlezoneOptions = options.subtitlezone = merge(options.subtitlezone, subtitlezoneOptions);

	    // add title and subtitle and subtitlezone
		each([
			['title', titleOptions, chartTitleOptions],
			['subtitle', subtitleOptions, chartSubtitleOptions],
			['subtitlezone', subtitlezoneOptions, chartsubtitlezoneOptions]
		], function (arr) {
			var name = arr[0],
				title = chart[name],
				titleOptions = arr[1],
	...
	layOutTitles: function () {
		var titleOffset = 0,
	        ...
	        subtitlezone = this.subtitlezone,
			options = this.options,
			titleOptions = options.title,
			subtitleOptions = options.subtitle,
			subtitlezoneOptions = options.subtitlezone,
		...
		if (subtitlezone) {
		    subtitlezone
				.css({ width: (subtitlezoneOptions.width || autoWidth) + PX })
				.align(extend({ y: titleOffset + titleOptions.margin }, subtitlezoneOptions), false, 'spacingBox');

		    if (!subtitlezoneOptions.floating && !subtitlezoneOptions.verticalAlign) {
		        titleOffset = mathCeil(titleOffset + subtitlezone.getBBox().height);
		    }
		}
	...
	destroy: function () {
	    ...
	    each(['title', 'subtitle', 'subtitlezone', 'chartBackground', 'plotBackground', 'plotBGImage', 
